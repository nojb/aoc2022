...
function main()
   ...
   table.insert(t, {{2}})
   table.insert(t, {{6}})
   table.sort(t, function (t1, t2) return compare(t1, t2) <= 0 end)
   local i = table.find(t, function (t) return compare(t, {{2}}) == 0 end)
   local j = table.find(t, function (t) return compare(t, {{6}}) == 0 end)
   return i * j
end
